...
import { deviceApi, organizationApi, siteApi, productApi, driverApi } from '@/services/api';
import type { Device, Organization, Site, Product, Driver } from '@/types';
...
export default function DeviceList() {
  ...
  const fetchData = async () => {
    ...
    setLoading(true);
    try {
      const [deviceData, orgData, siteData, productData, driverData] = await Promise.all([
      ...
      setSites(Array.isArray(siteData.list) ? siteData.list : []);
    ...
    <div>
      ...
      >
        <Form form={form} layout="vertical" onFinish={handleAdd}>
          ...
          <Form.Item name="site_id" label="所属站点">
            <Select
              placeholder="请选择站点"
              allowClear
              showSearch
